...
//		FATAL(6, "fatal", "[致命]"),
//		OFF(7, "off", "[关闭]");
		ALL(0, "all", I18N.formatMessage(YMP.__LSTRING_FILE, null, null, "ymp.commons.logger_type_all")),
		TRACE(1, "trace", I18N.formatMessage(YMP.__LSTRING_FILE, null, null, "ymp.commons.logger_type_trace")),
		DEBUG(2, "debug", I18N.formatMessage(YMP.__LSTRING_FILE, null, null, "ymp.commons.logger_type_debug")),
		INFO(3, "info", I18N.formatMessage(YMP.__LSTRING_FILE, null, null, "ymp.commons.logger_type_info")),
		WARN(4, "warn", I18N.formatMessage(YMP.__LSTRING_FILE, null, null, "ymp.commons.logger_type_warn")),
		ERROR(5, "error", I18N.formatMessage(YMP.__LSTRING_FILE, null, null, "ymp.commons.logger_type_error")),
		FATAL(6, "fatal", I18N.formatMessage(YMP.__LSTRING_FILE, null, null, "ymp.commons.logger_type_fatal")),
		OFF(7, "off", I18N.formatMessage(YMP.__LSTRING_FILE, null, null, "ymp.commons.logger_type_off"));
