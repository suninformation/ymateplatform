...
public class XMLConfigFileHandler {
    ...
    public static void main(String[] args) throws Exception {
        XMLConfigFileHandler _handler = new XMLConfigFileHandler(new File("/Users/suninformation/IdeaProjects/ymate-cms/ymatecms-core-api/src/main/resources/cfgs/admin.cfg.xml"));
        _handler.load(false);
        System.out.println(_handler.toJSON());
    }
